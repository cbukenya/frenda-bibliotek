...
public static class DataSeeder
{
    public static async Task SeedAsync(AppDbContext db)
    {
        ...
        {
            new() { ISBN = "9780465050659", Title = "The Design of Everyday Things", AuthorId = donNorman.Id, GenreId = uxDesign.Id, Description = "A powerful primer on how design serves as the interface between objects and users.", TotalPages = 368, PublishedYear = 2013 },
            new() { ISBN = "9780132350884", Title = "Clean Code", AuthorId = bobMartin.Id, GenreId = agile.Id, Description = "A handbook of agile software craftsmanship covering principles and patterns.", TotalPages = 464, PublishedYear = 2008 },
            new() { ISBN = "9780374533557", Title = "Thinking, Fast and Slow", AuthorId = kahneman.Id, GenreId = cognitive.Id, Description = "An exploration of the two systems that drive the way we think.", TotalPages = 512, PublishedYear = 2011 },
            new() { ISBN = "9780062316097", Title = "Sapiens", AuthorId = harari.Id, GenreId = history.Id, Description = "A brief history of humankind from the Stone Age to the twenty-first century.", TotalPages = 443, PublishedYear = 2011 },
            new() { ISBN = "9780135957059", Title = "The Pragmatic Programmer", AuthorId = thomasHunt.Id, GenreId = agile.Id, Description = "Your journey to mastery — timeless advice on the craft of software development.", TotalPages = 352, PublishedYear = 2019 },
            new() { ISBN = "9780441013593", Title = "Dune", AuthorId = herbert.Id, GenreId = spaceOpera.Id, Description = "The story of Paul Atreides on a desert planet that is the most valuable in the universe.", TotalPages = 688, PublishedYear = 1965 },
            new() { ISBN = "9780399590504", Title = "Educated", AuthorId = westover.Id, GenreId = memoir.Id, Description = "A memoir about a young woman who kept out of school until age 17, then earns a PhD from Cambridge.", TotalPages = 352, PublishedYear = 2018 },
            new() { ISBN = "9780735211292", Title = "Atomic Habits", AuthorId = clear.Id, GenreId = selfHelp.Id, Description = "An easy and proven way to build good habits and break bad ones.", TotalPages = 320, PublishedYear = 2018 },
            new() { ISBN = "9780345391803", Title = "The Hitchhiker's Guide to the Galaxy", AuthorId = adams.Id, GenreId = sciFi.Id, Description = "The hitchhiker's guide to everything — start with a bathrobe.", TotalPages = 193, PublishedYear = 1979 },
            new() { ISBN = "9780140449334", Title = "Meditations", AuthorId = aurelius.Id, GenreId = philosophy.Id, Description = "Personal writings of the Roman Emperor — a cornerstone of Stoic philosophy.", TotalPages = 254, PublishedYear = 180 },
        };
